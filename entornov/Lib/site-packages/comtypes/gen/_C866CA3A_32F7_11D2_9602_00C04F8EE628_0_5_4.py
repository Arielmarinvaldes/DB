...
__all__ = [
    'DISPID_SDKSetBinaryValue', 'STCRemoteServer', 'SPSMF_UPS',
    'SSFMOpenForRead', 'SpeechCategoryRecognizers', 'SPBO_TIME_UNITS',
    'Speech_Max_Pron_Length', 'SLOStatic',
    'DISPID_SRGCmdLoadFromObject', 'SpeechStreamSeekPositionType',
    'SAFT8kHz16BitMono', 'SAFT11kHz8BitStereo',
    'SpTextSelectionInformation', 'SAFT8kHz8BitMono',
    'DISPID_SPRules_NewEnum', 'SPWT_LEXICAL',
    'SpStreamFormatConverter', 'SPEI_FALSE_RECOGNITION',
    'eLEXTYPE_RESERVED10', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechRecoContext', 'DISPID_SFSOpen', 'SpLexicon',
    'SpCompressedLexicon', 'SASStop', 'SVP_3', 'SAFT24kHz16BitStereo',
    'Speech_Default_Weight', 'ISpeechPhraseReplacement',
    'SpeechTokenShellFolder', 'STCAll', 'ISpPhoneConverter',
    'DISPID_SpeechLexiconWord', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPRuleConfidence', 'DISPID_SRGCmdLoadFromFile',
    'SPLO_STATIC', 'SPPARTOFSPEECH', 'SRSEIsSpeaking', 'SITooSlow',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVESentenceBoundary',
    'DISPID_SRCEEndStream', 'SPINTERFERENCE_NOSIGNAL',
    'SAFT32kHz16BitStereo', 'SpWaveFormatEx', 'DISPID_SOTCGetDataKey',
    'SVP_13', 'DISPID_SVAudioOutputStream',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechLexiconPronunciation',
    'SRTEmulated', 'SPSModifier', 'DISPID_SLPPartOfSpeech',
    'SRSActiveAlways', 'SDTAudio', 'SDTRule', 'DISPID_SVSPhonemeId',
    'SPEI_SR_PRIVATE', 'DISPID_SRProfile', 'DISPID_SpeechVoiceStatus',
    ...
    'SRADefaultToActive', 'DISPID_SVEAudioLevel',
    'SPEI_START_SR_STREAM', 'SpeechGrammarState',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpNotifySink',
    'SAFTNoAssignedFormat', 'eLEXTYPE_USER', 'SECNormalConfidence',
    'SpSharedRecognizer', 'SREInterference', 'ISpNotifySource',
    'ISpeechVoiceStatus', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechGrammarRule', 'SAFTExtendedAudioFormat',
    'SFTSREngine', 'eLEXTYPE_RESERVED9', 'ISpeechResourceLoader',
    'DISPID_SBSSeek', 'LONG_PTR', 'SP_VISEME_1', 'ISpXMLRecoResult',
    'DISPID_SPEsCount', 'SVP_16', 'SPRULE', 'SP_VISEME_14',
    'DISPID_SGRSTs_NewEnum', 'eLEXTYPE_APP', 'SREAudioLevel',
    'SGRSTTWord', 'DISPID_SPIReplacements',
    'DISPID_SpeechAudioBufferInfo', 'SVSFParseSapi', 'SPFM_NUM_MODES',
    'SPEI_MIN_TTS', 'SpFileStream', 'SPSHORTCUTTYPE',
    'SpeechPartOfSpeech', 'SPWORDPRONOUNCEABLE', 'SVP_7',
    'DISPID_SRCEPropertyStringChange', 'ISpStreamFormatConverter',
    'SPPS_Interjection', 'ISpPhoneticAlphabetConverter',
    'SDA_Two_Trailing_Spaces', 'ISpeechFileStream',
    'DISPID_SRCEBookmark', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFT22kHz8BitStereo', 'SPSUnknown', 'ISpDataKey',
    'SAFT11kHz16BitStereo', 'DISPID_SPEPronunciation',
    'SpeechWordType', 'DISPID_SPRsItem', 'DISPID_SVEViseme',
    'SpObjectTokenCategory', 'DISPID_SRCSetAdaptationData',
    'SPPS_RESERVED4', 'DISPID_SpeechPhraseBuilder', 'ISpeechVoice',
    'SPPHRASEELEMENT', 'SLTApp', 'DISPID_SGRsDynamic',
    'SAFT22kHz16BitMono', 'SPPHRASEPROPERTY',
    'DISPID_SASCurrentSeekPosition', 'ISpeechMMSysAudio',
    'SINoSignal', 'SAFT32kHz8BitStereo', 'SPGS_ENABLED', 'SPBO_NONE',
    'IStream', 'SPWORDPRONUNCIATION', 'SPEI_VOICE_CHANGE',
    'SPPS_NotOverriden', 'DISPID_SpeechFileStream', 'SSFMCreate',
    'DISPID_SVSLastBookmarkId', 'SVF_None', 'SAFT12kHz8BitMono',
    'SGDSActiveUserDelimited', 'SAFT32kHz16BitMono',
    'SPSEMANTICERRORINFO', 'SpeechUserTraining',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechLexiconPronunciation',
    'SPSHT_NotOverriden', 'SP_VISEME_15', 'DISPID_SGRSTWeight',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVEventInterests',
    'SAFT12kHz8BitStereo', 'SpeechPropertyResourceUsage',
    'SpeechRecoEvents', 'DISPID_SpeechAudio',
    'ISpObjectTokenCategory', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SLPLangId', 'SVSFlagsAsync', 'SPEI_WORD_BOUNDARY',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechPhraseInfo',
    'DISPID_SWFEBitsPerSample', 'SPEI_SOUND_END', 'SP_VISEME_5',
    'SPEVENTENUM', 'ISpeechAudioStatus', 'SPLOADOPTIONS',
    'DISPID_SpeechRecoResult2', 'SREPropertyNumChange',
    'IInternetSecurityMgrSite', 'DISPID_SPRuleChildren',
    'DISPID_SPPs_NewEnum', 'SpeechDiscardType', 'SBONone',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPGS_EXCLUSIVE',
    'SP_VISEME_8', 'SpMMAudioOut', 'SPAR_Unknown', 'SVEPrivate',
    'DISPID_SPIAudioSizeTime', 'ISpRecognizer',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRs_NewEnum',
    'DISPID_SAFGetWaveFormatEx', 'SPSEMANTICFORMAT',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPRDisplayAttributes', 'SASClosed', 'DISPID_SRGRules',
    'ISpeechObjectToken', 'DISPID_SRCEAdaptation',
    'DISPID_SVSRunningState', 'DISPID_SVGetAudioInputs',
    'SPSNotOverriden', 'DISPID_SVEPhoneme',
    'DISPID_SRSCurrentStreamPosition', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRGCmdSetRuleState', 'SECFEmulateResult',
    'DISPID_SPEDisplayText', 'SRTAutopause',
    'SpeechVoiceSkipTypeSentence', 'SVEBookmark',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRName', 'DISPID_SPEs_NewEnum',
    'DISPID_SABIMinNotification', 'SRATopLevel',
    'DISPID_SWFEChannels', 'SRESoundStart', 'ISpeechCustomStream',
    'SpeechInterference', 'ISpeechGrammarRuleStateTransitions',
    'SpeechBookmarkOptions', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SVGetVoices', 'SITooLoud', 'SVEPhoneme',
    'DISPID_SpeechPhraseProperties', 'DISPIDSPTSI',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVVolume', 'SpVoice',
    'ISpeechLexiconWord', 'SPCT_SLEEP', 'DISPID_SPAsItem',
    'SPFM_CREATE', 'SRCS_Disabled', 'DISPID_SGRSTsCount',
    'DISPID_SVEStreamStart', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCERecognition', 'ISpeechWaveFormatEx', 'SVP_21',
    'SPRST_INACTIVE_WITH_PURGE', 'SSSPTRelativeToEnd',
    'DISPID_SDKGetBinaryValue', 'SGLexical', 'SRTExtendableParse',
    'DISPID_SPIElements', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRGCmdLoadFromResource', '_ISpeechVoiceEvents',
    'SPDKL_CurrentConfig', 'SRTReSent', 'SAFT11kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'SP_VISEME_16',
    'DISPID_SPRFirstElement', 'SPADAPTATIONRELEVANCE',
    'ISpGrammarBuilder', 'SPRST_INACTIVE', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCEAudioLevel',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVEAudioLevel',
    'SPEI_RESERVED3', 'ISpRecoResult', 'SBOPause',
    'DISPID_SRCBookmark', 'DISPID_SREmulateRecognition',
    'DISPID_SRCEInterference', 'SPEI_RESERVED1', 'DISPID_SOTSetId',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPPConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SREAllEvents',
    'DISPID_SOTCategory', 'SPAO_RETAIN_AUDIO', 'SFTInput',
    'DISPID_SPPId', 'DISPID_SVSVisemeId',
    'DISPID_SPEActualConfidence', 'DISPID_SPRNumberOfElements',
    'DISPID_SASState', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SMSAMMHandle', 'tagSPPROPERTYINFO', 'ISpPhrase',
    'DISPID_SpeechPhraseElement', 'SRARoot', 'SPVPRIORITY',
    'SAFT24kHz8BitMono', 'DISPID_SPIStartTime',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRCERequestUI',
    'DISPID_SPERequiredConfidence', 'SP_VISEME_6',
    'SPDKL_CurrentUser', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCEFalseRecognition',
    'SRSInactiveWithPurge', 'DISPIDSPTSI_SelectionLength',
    'SPGRAMMARSTATE', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPRText', 'SpeechCategoryAudioOut',
    'DISPID_SRRSetTextFeedback', 'SVP_14', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechRecognizerStatus', 'SAFT12kHz16BitStereo',
    'DISPID_SAEventHandle', 'DISPID_SLGetGenerationChange',
    'DISPID_SGRAddState', 'DISPID_SPPName', 'DISPID_SPRs_NewEnum',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE9',
    'SRERecoOtherContext', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCRecognizer', 'SASPause',
    'ISpRecoCategory', 'SVP_9', 'SPRECOSTATE', 'DISPID_SVSkip',
    'SRAONone', 'DISPID_SVWaitUntilDone',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPIAudioSizeBytes',
    'SAFT11kHz16BitMono', 'DISPID_SRCState', 'SRCS_Enabled',
    'DISPID_SpeechGrammarRules', 'ISpProperties', 'SPRST_NUM_STATES',
    'SpUnCompressedLexicon', 'SPDATAKEYLOCATION',
    'DISPID_SRCESoundEnd', 'SASRun', 'DISPID_SWFESamplesPerSec',
    'SPBO_PAUSE', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRRPhraseInfo', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_RESERVED4', 'SpCustomStream', 'SP_VISEME_7',
    'DISPID_SPCPhoneToId', 'SpMMAudioIn', 'DISPID_SRGetFormat',
    'DISPID_SRCRetainedAudioFormat', 'SGDSActive',
    'DISPID_SVEStreamEnd', 'ISpeechRecoResult2', 'SP_VISEME_12',
    'SREStreamStart', 'eLEXTYPE_PRIVATE1', 'DISPID_SVAudioOutput',
    ...
    'DISPID_SGRSTRule', 'SPEI_PHRASE_START',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechMemoryStream',
    'DISPID_SPPFirstElement', 'SECFDefault', 'SVEViseme',
    'DISPID_SMSALineId', 'ISpeechPhoneConverter', 'DISPID_SLGetWords',
    'DISPID_SRCEHypothesis', 'DISPIDSPTSI_ActiveOffset', 'SVP_12',
    'DISPID_SOTsItem', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SRERecognition', 'DISPID_SPPEngineConfidence',
    'DISPID_SRGSetWordSequenceData', 'SAFTADPCM_44kHzStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechRuleState',
    'DISPID_SGRSTType', 'SPPHRASEREPLACEMENT',
    'SAFTNonStandardFormat', 'SRAORetainAudio', 'SpeechAddRemoveWord',
    'SPRECORESULTTIMES', 'DISPID_SPPsItem', 'SVSFParseMask',
    'SPSHT_OTHER', 'DISPID_SRGSetTextSelection', 'SVEAllEvents',
    'SPINTERFERENCE_NOISE', 'DISPID_SRIsShared', 'SPSHT_EMAIL',
    'SGSDisabled', 'DISPID_SLWWord', 'SDTProperty',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SGRSTTWildcard', 'ISpAudio',
    'DISPID_SRRRecoContext', 'DISPID_SpeechRecoResult',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPIGetDisplayAttributes',
    'SP_VISEME_2', 'SpeechLoadOption', 'SVP_19',
    'DISPID_SpeechCustomStream', 'SpeechTokenKeyFiles',
    'DISPID_SABIBufferSize', 'ISpeechPhraseRule', 'SVP_18',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SGRSTPropertyName',
    'DISPID_SVSpeakStream', 'SAFTCCITT_ALaw_22kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPINTERFERENCE',
    'DISPID_SRCreateRecoContext', 'SRTSMLTimeout',
    'DISPID_SRCESoundStart', 'SpeechRegistryUserRoot', 'SPAS_RUN',
    'DISPID_SpeechRecognizer', 'SpeechVoicePriority',
    'DISPID_SRRTTickCount', 'DISPID_SRGetPropertyNumber',
    'SVF_Stressed', 'SpeechGrammarTagDictation',
    'SpeechEmulationCompareFlags', 'ISpStreamFormat',
    'ISpeechPhraseAlternate', 'SpeechTokenKeyUI', 'DISPID_SBSWrite',
    'SVSFUnusedFlags', 'DISPID_SpeechGrammarRuleState',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPPParent',
    'DISPID_SRSetPropertyString', 'SpeechStreamFileMode',
    'DISPID_SASCurrentDevicePosition', 'SpeechRecognizerState',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_PRIVATE18', 'SP_VISEME_17',
    'DISPID_SGRsCount', 'DISPID_SVEBookmark', 'SPPS_RESERVED3',
    'SPGRAMMARWORDTYPE', 'SDTLexicalForm',
    'DISPID_SRSCurrentStreamNumber', 'SPPHRASE', 'SPWT_PRONUNCIATION',
    'SPRECOGNIZERSTATUS', 'DISPID_SLWType', 'STCLocalServer',
    'SAFT48kHz8BitStereo', 'UINT_PTR', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPAs_NewEnum', 'SPEI_PHONEME', 'STSF_FlagCreate',
    'DISPID_SpeechMMSysAudio', 'SLTUser', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPPBRestorePhraseFromMemory', 'eLEXTYPE_PRIVATE8',
    'ISpeechRecoResultDispatch', 'DISPID_SRGIsPronounceable',
    'DISPID_SWFEAvgBytesPerSec', 'SWTDeleted', 'DISPID_SLPs_NewEnum',
    'DISPID_SGRAddResource', 'SVP_0', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SLPsItem', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SBSFormat',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechLexicon',
    'eLEXTYPE_RESERVED6', 'DISPID_SPIGrammarId', 'SVF_Emphasis',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVEVoiceChange',
    'SpObjectToken', 'DISPID_SGRSAddWordTransition',
    'DISPID_SDKGetlongValue', 'DISPID_SDKOpenKey', 'DISPID_SOTCId',
    'DISPID_SAFType', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechRecoResultTimes', 'SPSTREAMFORMATTYPE',
    'SpResourceManager', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVEEndInputStream', 'DISPID_SpeechAudioStatus', 'ISpVoice',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRGDictationSetState', 'DISPID_SRGDictationLoad',
    'SPEI_REQUEST_UI', 'ISpeechRecognizer', 'SPEI_SR_RETAINEDAUDIO',
    'SPRS_INACTIVE', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpPhoneticAlphabetConverter', 'DISPID_SVEWord', 'SP_VISEME_0',
    'DISPID_SWFEExtraData', 'SPBINARYGRAMMAR', 'WAVEFORMATEX',
    'DISPID_SPRuleName', 'SpeechMicTraining',
    'DISPID_SPAStartElementInResult', 'DISPID_SLPType',
    'SVEWordBoundary', 'STCInprocHandler', 'DISPID_SpeechPhraseRules',
    'SpeechFormatType', 'DISPID_SGRAttributes',
    'DISPID_SRCEStartStream', 'DISPID_SRCRetainedAudio',
    'DISPID_SPRulesItem', 'DISPID_SGRsAdd', 'DISPID_SAFGuid',
    'IEnumSpObjectTokens', 'DISPID_SpeechAudioFormat', 'SPXRO_SML',
    'ISpPhoneticAlphabetSelection', 'SPAUDIOBUFFERINFO',
    'SpInprocRecognizer', 'SPWF_SRENGINE', 'SVP_1',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPSSuppressWord',
    'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE6',
    'DISPID_SASFreeBufferSpace', 'eWORDTYPE_DELETED',
    'DISPID_SGRInitialState', 'SPPS_LMA',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPLO_DYNAMIC',
    'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCCreateGrammar', 'ISpSerializeState', 'ISpeechAudio',
    'SPEI_SOUND_START', 'ISpRecoContext', 'SAFTADPCM_44kHzMono',
    'SpAudioFormat', 'DISPID_SOTs_NewEnum', 'ISpRecoGrammar2',
    'DISPID_SLGetPronunciations', 'DISPID_SRRAlternates',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPRuleId',
    'DISPID_SpeechPhraseRule', 'SWPKnownWordPronounceable', 'SVP_10',
    'SpeechTokenValueCLSID', 'SAFT16kHz8BitMono',
    'DISPID_SGRSTNextState', 'ISpMMSysAudio', 'DISPID_SGRsFindRule',
    'SVP_5', 'DISPID_SRRGetXMLErrorInfo', 'SPCONTEXTSTATE',
    'SAFTGSM610_22kHzMono', 'SDTDisplayText',
    'tagSPTEXTSELECTIONINFO', 'SAFTADPCM_22kHzStereo',
    'SpeechAudioVolume', 'SVP_15', 'eLEXTYPE_PRIVATE15',
    'SSTTWildcard', 'DISPID_SDKGetStringValue', 'SPPHRASERULE',
    'DISPID_SpeechVoice', 'DISPID_SABIEventBias', 'SP_VISEME_19',
    'SGDSActiveWithAutoPause', 'DISPID_SOTGetDescription',
    'DISPID_SPARecoResult', 'SP_VISEME_13', 'SDKLCurrentConfig',
    'SAFT48kHz16BitMono', 'SGSExclusive',
    'SDA_Consume_Leading_Spaces', 'SP_VISEME_9',
    'SVESentenceBoundary', 'ISpeechGrammarRules',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCCreateResultFromMemory', 'SAFT32kHz8BitMono',
    'SPEI_RESERVED5', 'SDKLCurrentUser', 'eWORDTYPE_ADDED',
    '__MIDL_IWinTypes_0009', 'SECFNoSpecialChars',
    'SpeechCategoryAudioIn', 'SpeechEngineProperties', 'SPVISEMES',
    'ISpeechRecoResult', 'SRADynamic',
    'SpeechPropertyHighConfidenceThreshold', 'SVPNormal',
    'SpeechCategoryAppLexicons', 'SpPhraseInfoBuilder',
    'DISPID_SRRTimes', 'SAFT12kHz16BitMono',
    'ISpeechPhraseReplacements', 'SPWORDLIST', 'SDTReplacement',
    'DISPID_SPPChildren', 'DISPID_SRRAudio', 'SPAUDIOOPTIONS',
    'SpeechDisplayAttributes', 'SWTAdded', 'ISpObjectWithToken',
    'SECFIgnoreWidth', 'SPEI_RECOGNITION', 'SAFT44kHz8BitStereo',
    'SPEI_TTS_PRIVATE', 'ISpeechPhraseProperty',
    'DISPID_SDKCreateKey', 'SREPhraseStart', 'SPEI_END_INPUT_STREAM',
    'DISPID_SLPPhoneIds', 'SITooQuiet', 'SLODynamic', 'ISpLexicon',
    '_ISpeechRecoContextEvents', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SVResume', 'SPPS_Modifier',
    'DISPID_SPERetainedStreamOffset', '_RemotableHandle',
    'SAFT22kHz8BitMono', 'SDA_No_Trailing_Space',
    'DISPID_SLRemovePronunciation', 'SPSNoun', 'eLEXTYPE_PRIVATE13',
    'SP_VISEME_11', 'DISPID_SPACommit', 'SAFT16kHz16BitMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'eLEXTYPE_PRIVATE10',
    'SpeechGrammarTagWildcard', 'DISPID_SOTDataKey', 'DISPID_SVRate',
    'SpeechRuleAttributes', 'STSF_AppData', 'DISPID_SLPsCount',
    'SPWF_INPUT', 'SPXRO_Alternates_SML',
    'ISpeechObjectTokenCategory', 'SPEI_TTS_BOOKMARK',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRecoContextState',
    'SPSERIALIZEDRESULT', 'SpeechRunState', 'ISpeechPhraseRules',
    'ISpeechXMLRecoResult', 'DISPIDSPRG', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechPhraseElements', 'SVSFVoiceMask',
    'SpeechRecognitionType', 'DISPID_SASetState', 'SVSFIsFilename',
    'SPPS_Noncontent', 'DISPID_SRGCmdSetRuleIdState',
    'eLEXTYPE_PRIVATE2', 'SpeechVoiceSpeakFlags', 'SPEI_SR_BOOKMARK',
    'ISpeechPhraseInfoBuilder', 'SINoise', 'SpMMAudioEnum',
    'DISPID_SpeechGrammarRuleStateTransition', 'STSF_CommonAppData',
    'SpeechSpecialTransitionType', 'SpeechAudioState',
    'DISPID_SRRAudioFormat', 'ISpeechDataKey', 'STCInprocServer',
    'SPWORD', 'SpeechVisemeFeature', 'DISPID_SPCLangId',
    'STSF_LocalAppData', 'SpeechCategoryPhoneConverters',
    'DISPID_SFSClose', 'DISPID_SPIProperties',
    'ISpeechRecognizerStatus', 'SPEI_MIN_SR', 'SVSFIsXML',
    'ISpNotifyTranslator', 'SSFMOpenReadWrite', 'SPSERIALIZEDPHRASE',
    'DISPID_SRCERecognizerStateChange', 'SPEVENT',
    'DISPID_SRRTStreamTime', 'SP_VISEME_10', 'DISPID_SVIsUISupported',
    'eLEXTYPE_PRIVATE11', 'SpeechGrammarWordType', 'SRSEDone',
    'SVSFPersistXML', 'tagSTATSTG', 'SAFT44kHz16BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'ISpObjectToken',
    'SPFM_CREATE_ALWAYS', 'SAFTADPCM_8kHzMono',
    'SpeechPropertyNormalConfidenceThreshold', 'SPFM_OPEN_READWRITE',
    'ISpRecoContext2', 'SP_VISEME_18',
    'DISPID_SVSCurrentStreamNumber', 'Speech_Max_Word_Length',
    'SWPUnknownWordPronounceable', 'SpeechDictationTopicSpelling',
    'SVSFNLPMask', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SDKSetLongValue', 'SRESoundEnd', 'SECHighConfidence',
    'DISPID_SDKEnumKeys', 'SpShortcut', 'DISPID_SRCEEnginePrivate',
    'SPPROPERTYINFO', 'SpeechTokenKeyAttributes',
    'SAFT8kHz8BitStereo', 'DISPID_SVPause', 'DISPID_SGRSTransitions',
    'SPDKL_DefaultLocation', 'SPEI_VISEME', 'SECFIgnoreCase',
    'SVP_11', 'SGRSTTEpsilon', 'DISPID_SOTIsUISupported',
    'SPCATEGORYTYPE', 'SECLowConfidence', 'SPCT_COMMAND',
    'DISPID_SDKEnumValues', 'SPEI_RESERVED6',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRCCmdMaxAlternates',
    'ISpeechAudioBufferInfo', 'DISPID_SMSGetData',
    'SpeechVoiceEvents', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRDisplayUI', 'DISPID_SRCResume', 'SAFTADPCM_8kHzStereo',
    'ISpeechLexiconWords', 'SpMemoryStream', 'DISPID_SRRecognizer',
    'SGRSTTRule', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SPIRule',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPSInterjection',
    'DISPID_SpeechPhoneConverter', 'ISpeechLexiconPronunciations',
    'eLEXTYPE_PRIVATE19', 'SpeechRecoProfileProperties',
    'DISPID_SVSInputSentencePosition', 'DISPID_SOTGetAttribute',
    'SREAdaptation', 'DISPID_SRGCommit', 'DISPID_SGRSRule',
    'SPEI_MAX_SR', 'ISpeechGrammarRule', '_SPAUDIOSTATE',
    'ISpeechRecoGrammar', 'SRSActive', 'DISPID_SPIEnginePrivateData',
    'ISpRecognizer2', 'SPAO_NONE', 'SAFT44kHz8BitMono',
    'SAFT48kHz16BitStereo', 'ISpStream', 'SPEI_END_SR_STREAM',
    'SPAS_STOP', 'SAFTText', 'DISPID_SRIsUISupported',
    'ISpResourceManager', 'DISPID_SGRsItem', 'SpPhoneConverter',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SMSSetData',
    'DISPID_SVSLastResult', 'DISPID_SDKDeleteValue', 'SP_VISEME_20',
    'SpSharedRecoContext', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_RESERVED7', 'DISPID_SVSInputSentenceLength',
    'DISPID_SOTGetStorageFileName', 'SPVPRI_NORMAL',
    'ISequentialStream', 'IEnumString', 'SPBO_AHEAD',
    'DISPID_SPEsItem', 'SVP_20', 'ISpeechGrammarRuleState',
    'SAFT24kHz16BitMono', 'SDKLDefaultLocation', 'SPAUDIOSTATUS',
    'SPSHORTCUTPAIR', 'Speech_StreamPos_RealTime',
    'DISPID_SGRSTPropertyValue', 'SPTEXTSELECTIONINFO',
    'ISpeechPhraseProperties', 'SpeechAudioFormatType',
    'DISPID_SOTRemove', 'IInternetSecurityManager',
    'DISPID_SpeechBaseStream', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRSClsidEngine', 'DISPID_SPAPhraseInfo', 'SPAR_High',
    'ISpeechPhraseElements', 'eLEXTYPE_PRIVATE12',
    'SpeechWordPronounceable', 'DISPID_SOTId',
    'DISPID_SRAudioInputStream', 'DISPID_SOTRemoveStorageFileName',
    'SpeechAllElements', 'DISPID_SGRSTsItem',
    'DISPID_SPPNumberOfElements', 'DISPID_SRGState',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechLexiconWords',
    'DISPID_SPEEngineConfidence', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRRTLength',
    'SAFT44kHz16BitMono', 'SGSEnabled', 'SSFMCreateForWrite',
    'SpeechEngineConfidence', 'DISPID_SMSADeviceId', 'SPAR_Medium',
    'SGRSTTTextBuffer', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPWT_DISPLAY',
    'DISPID_SpeechObjectToken', 'SPPS_Noun',
    'DISPID_SpeechXMLRecoResult', 'SPPS_SuppressWord',
    'DISPID_SOTCEnumerateTokens', 'SPPS_RESERVED1',
    'DISPID_SpeechPhraseAlternate', 'SpeechVoiceCategoryTTSRate',
    'SPINTERFERENCE_NONE', 'DISPID_SPRuleNumberOfElements', 'SINone',
    'DISPID_SLWLangId', 'SREHypothesis', 'SVSFNLPSpeakPunc',
    'SpeechPropertyAdaptationOn', 'DISPID_SOTMatchesAttributes',
    'SSTTTextBuffer', 'SDTAll', 'SPRECOCONTEXTSTATUS',
    'SpeechGrammarTagUnlimitedDictation', 'SPEI_ADAPTATION',
    'SpeechDataKeyLocation', 'SPEI_RESERVED2',
    'DISPID_SPELexicalForm', 'DISPID_SVSInputWordPosition',
    'SpeechPropertyResponseSpeed', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPRuleFirstElement', 'SPINTERFERENCE_TOOQUIET',
    'SAFTGSM610_11kHzMono', 'SECFIgnoreKanaType', 'ISpPhraseAlt',
    'SPEI_START_INPUT_STREAM', 'SRAImport', 'DISPID_SPISaveToMemory',
    'eLEXTYPE_PRIVATE17', 'SSSPTRelativeToStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechObjectTokens',
    'SSTTDictation', 'DISPID_SRGetPropertyString',
    'DISPID_SRSNumberOfActiveRules', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPVOICESTATUS', 'ISpeechPhraseAlternates',
    'DISPID_SpeechPhraseReplacements', 'SPEI_TTS_AUDIO_LEVEL',
    'SPCS_ENABLED', 'SVSFParseSsml', 'SVP_6', 'SVP_17',
    'SpeechTokenContext', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPsCount', 'DISPID_SRSSupportedLanguages',
    'DISPID_SPIGetText', 'DISPID_SpeechLexiconProns',
    'SAFTADPCM_22kHzMono', 'ISpeechMemoryStream', 'DISPID_SPPValue',
    'SGRSTTDictation', 'DISPID_SRGId', 'SPPS_RESERVED2',
    'SPSHORTCUTPAIRLIST', 'SITooFast', 'DISPID_SpeechRecoContext',
    'SAFT24kHz8BitStereo', 'DISPID_SLWsCount', 'SVP_2',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SVVoice',
    'DISPID_SVSInputWordLength', 'eLEXTYPE_PRIVATE7',
    'DISPID_SGRsCommit', 'SDA_One_Trailing_Space',
    'DISPID_SpeechDataKey', 'DISPID_SRGDictationUnload',
    'DISPID_SGRSTPropertyId', 'DISPID_SPEAudioTimeOffset', 'SVPAlert',
    'SRSInactive', 'DISPID_SRRGetXMLResult', 'DISPID_SPCIdToPhone',
    'DISPID_SVStatus', 'SpNullPhoneConverter',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPWORDTYPE', 'SAFT16kHz8BitStereo',
    'SPCT_SUB_DICTATION', 'SVSFDefault', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SWFEFormatTag', 'ISpeechBaseStream', 'ISpRecognizer3',
    'SpeechCategoryVoices', 'DISPID_SGRId', 'DISPID_SRGetRecognizers',
    'SVEVoiceChange', 'SPVPRI_ALERT', 'ISpeechLexicon',
    'DISPID_SOTDisplayUI', 'SVSFIsNotXML', 'SPSHT_Unknown',
    'ISpEventSink', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPIEngineId',
    'DISPID_SRCVoice', 'SPGS_DISABLED', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SGRSTText', 'DISPID_SPRulesCount', 'SPSLMA',
    'SPRST_ACTIVE', 'DISPID_SVDisplayUI', 'SPCT_DICTATION',
    'SWPUnknownWordUnpronounceable', 'SPAR_Low', 'SPLEXICONTYPE',
    'SPEVENTSOURCEINFO', 'SRERequestUI', 'DISPID_SLWs_NewEnum',
    'DISPID_SLGenerationId', 'DISPID_SAVolume', 'ISpeechAudioFormat',
    'SAFT8kHz16BitStereo', 'SPEI_INTERFERENCE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVGetProfiles', 'SpeechVisemeType',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SDKDeleteKey',
    'Speech_StreamPos_Asap', 'SRAExport', 'SPRULESTATE',
    'DISPID_SPRsCount', 'DISPID_SpeechObjectTokens',
    'SPSMF_SAPI_PROPERTIES', 'SpNotifyTranslator',
    'DISPID_SWFEBlockAlign', 'SP_VISEME_3', 'SpeechLexiconType',
    'DISPID_SPAsCount', 'SpeechAudioProperties',
    'DISPID_SLWPronunciations', 'eLEXTYPE_PRIVATE20',
    'SDKLLocalMachine', 'DISPID_SVPriority', 'DISPID_SOTsCount',
    'DISPID_SOTCDefault', 'DISPID_SpeechPhraseProperty',
    'ISpeechRecoResultTimes', 'DISPID_SBSRead', 'SRTStandard',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpEventSource', 'SREStateChange',
    'DISPID_SRGReset', 'SpStream', 'SDTAlternates',
    'DISPID_SGRsCommitAndSave', 'SVP_4', 'SPAS_CLOSED', 'SPPS_Verb',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCEventInterests',
    'DISPID_SGRSAddSpecialTransition', 'SPWAVEFORMATTYPE',
    'SPDKL_LocalMachine', 'DISPID_SRStatus',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechPhraseElement',
    'SVEStartInputStream', 'DISPID_SVGetAudioOutputs', 'SPFILEMODE',
    'SPRS_ACTIVE', 'SPAS_PAUSE', 'SAFTADPCM_11kHzStereo',
    'SGDSInactive', 'DISPID_SOTCSetId', 'SPVPRI_OVER',
    'SPCT_SUB_COMMAND', 'SGPronounciation', 'DISPID_SRGRecoContext',
    'SVSFParseAutodetect', 'DISPID_SDKSetStringValue',
    'DISPID_SAStatus', 'SAFT48kHz8BitMono', 'DISPID_SRAudioInput',
    'SDTPronunciation', 'SGLexicalNoSpecialChars',
    'SAFTGSM610_8kHzMono', 'SREStreamEnd', 'SVP_8',
    'SpeechPropertyLowConfidenceThreshold', 'SVPOver', 'SPPS_Unknown',
    'DISPID_SRRSaveToMemory', 'SREBookmark', 'DISPID_SLPSymbolic',
    'SAFT16kHz16BitStereo', 'DISPID_SPILanguageId', 'ISpRecoGrammar',
    'SPSFunction', 'SREPropertyStringChange', 'SPPS_Function',
    'eLEXTYPE_PRIVATE4', 'SPEI_MAX_TTS', 'SAFTGSM610_44kHzMono',
    'DISPID_SLAddPronunciation', 'DISPID_SABufferInfo', 'ISpShortcut',
    'SREPrivate', 'SPEI_UNDEFINED', 'DISPID_SLWsItem',
    'DISPID_SRCEPhraseStart', 'DISPID_SRState',
    'DISPID_SRSAudioStatus', 'DISPID_SRCPause', 'SGDisplay',
    'DISPID_SGRClear', 'SPCS_DISABLED', 'DISPID_SVSLastBookmark',
    'DISPID_SADefaultFormat', 'SREFalseRecognition', 'SP_VISEME_4',
    'SP_VISEME_21', 'SPSVerb', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechTextSelectionInformation',
    'DISPID_SVSpeak', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SVEEnginePrivate', 'SPFM_OPEN_READONLY', 'SAFTDefault',
    'SPAUDIOSTATE'
]

_check_version('1.1.14', 1652473372.093988)
